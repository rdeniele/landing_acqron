      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-stretch gap-8 mb-12 sm:mb-20">
          <div className="flex-1 bg-[#1e1e1e] rounded-xl p-6 shadow-md text-center border border-[#333]">
            ...
            <p className="text-[#d1d1d1] text-base sm:text-lg leading-relaxed">To listen, understand, and respond to the world’s needs by building innovative software that makes life better.</p>
          </div>
          <div className="flex-1 bg-[#1e1e1e] rounded-xl p-6 shadow-md text-center border border-[#333]">
            <h2 className="text-[#e54e3f] text-2xl sm:text-3xl font-bold mb-3">Our Vision</h2>
            <p className="text-[#d1d1d1] text-base sm:text-lg leading-relaxed">To improve people’s lives by identifying and solving the problems that truly matter, making everyday experiences more comfortable and meaningful.</p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-16">
          <h3 className="text-[#facb15] text-2xl sm:text-3xl font-bold text-center mb-8">Our Process</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            <div className="bg-[#1e1e1e] rounded-xl p-6 shadow-md text-center border border-[#333] flex flex-col items-center">
              <div className="text-3xl mb-2 text-[#facb15]"><FaSearch /></div>
              <h4 className="text-white text-lg font-semibold mb-2">Discovery Call</h4>
              <p className="text-[#b1b1b1] text-sm">We start with a conversation to understand your vision, needs, and goals.</p>
            </div>
            <div className="bg-[#1e1e1e] rounded-xl p-6 shadow-md text-center border border-[#333] flex flex-col items-center">
              <div className="text-3xl mb-2 text-[#facb15]"><FaRegEdit /></div>
              <h4 className="text-white text-lg font-semibold mb-2">Define</h4>
              <p className="text-[#b1b1b1] text-sm">We clarify the problem and design the right solution together.</p>
            </div>
            <div className="bg-[#1e1e1e] rounded-xl p-6 shadow-md text-center border border-[#333] flex flex-col items-center">
              <div className="text-3xl mb-2 text-[#facb15]"><FaLaptopCode /></div>
              <h4 className="text-white text-lg font-semibold mb-2">Develop</h4>
              <p className="text-[#b1b1b1] text-sm">We build, iterate, and test with you every step of the way.</p>
            </div>
            <div className="bg-[#1e1e1e] rounded-xl p-6 shadow-md text-center border border-[#333] flex flex-col items-center">
              <div className="text-3xl mb-2 text-[#facb15]"><FaRocket /></div>
              <h4 className="text-white text-lg font-semibold mb-2">Deliver</h4>
              <p className="text-[#b1b1b1] text-sm">We launch, support, and help you grow for long-term success.</p>
            </div>
          </div>
        </div>
          </div>
