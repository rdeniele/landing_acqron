      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="bg-[#1e1e1e] p-6 sm:p-8 rounded-xl border-t-4 border-[#facb15]">
            ...
            <p className="text-[#d1d1d1] text-sm sm:text-base leading-relaxed mb-4 sm:mb-6">
              Acqron helped us go from idea to a working MVP in just 8 weeks. Their expertise in
              startup development is unmatched!
            </p>
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#e54e3f] rounded-full flex items-center justify-center text-white font-bold text-base sm:text-lg">
                RS
              </div>
              <div>
          ...
          <div className="bg-[#1e1e1e] p-6 sm:p-8 rounded-xl border-t-4 border-[#facb15]">
            <div className="text-[#facb15] text-2xl sm:text-3xl mb-2 sm:mb-4">&quot;</div>
            <p className="text-[#d1d1d1] text-sm sm:text-base leading-relaxed mb-4 sm:mb-6">
              Professional, responsive, and results-driven. Acqron transformed our vision into a
          ...
          <div className="bg-[#1e1e1e] p-6 sm:p-8 rounded-xl border-t-4 border-[#facb15]">
            <div className="text-[#facb15] text-2xl sm:text-3xl mb-2 sm:mb-4">&quot;</div>
            <p className="text-[#d1d1d1] text-sm sm:text-base leading-relaxed mb-4 sm:mb-6">
              The team at Acqron understood our needs perfectly and delivered beyond expectations.
              Highly recommend!
            </p>
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#e54e3f] rounded-full flex items-center justify-center text-white font-bold text-base sm:text-lg">
